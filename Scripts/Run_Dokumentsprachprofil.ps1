...
$PyFile = Join-Path $Root "Scripts\python_runner\031_dokumentsprachprofil_v1.py"
$LogDir = Join-Path $Root "Windows_App\Logs"
$Ts = Get-Date -Format "yyyy-MM-dd_HH-mm-ss"
$Report = Join-Path $LogDir "RUN_DOKUMENTSPRACHPROFIL_$Ts.txt"
$Failed = $false
...
try {
    W "DOKUMENTSPRACHPROFIL gestartet."
    W "Root: $Root"
    W "Report: $Report"
    ...
    W "DOKUMENTSPRACHPROFIL abgeschlossen."
    ...
    if ($Failed) {
        ...
        Write-Host "Dokumentsprachprofile sind erzeugt."
    }
}
