...
.DESCRIPTION
    Kopiert Dateien gemaess Migrationsplan.
...
$runner = Join-Path $projektWurzel "Scripts\python_runner\core17_kopierende_migration.py"
$check = Join-Path $projektWurzel "Scripts\python_runner\check_core17_kopierende_migration.py"

function Write-Log {
    param([string]$msg)
    Write-Host "[CORE-17] $msg"
}

Write-Log "Starte CORE-17 Kopierende Migration..."
...
Write-Log "CORE-17 KOPIERENDE MIGRATION ERFOLGREICH ABGESCHLOSSEN."
