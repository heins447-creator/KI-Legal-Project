...
$Runner       = "$BaseDir\Scripts\python_runner\ext002_paddleocr_layout.py"
$Check        = "$BaseDir\Scripts\python_runner\check_ext002_paddleocr_layout.py"

Write-Host "========================================"
Write-Host " EXT-002 - PaddleOCR Layout Autolauf"
Write-Host "========================================"
...
Write-Host ""
Write-Host "EXT-002 Autolauf erfolgreich abgeschlossen."
