...
$Runner       = "$BaseDir\Scripts\python_runner\ext005_semantische_suche.py"
$Check        = "$BaseDir\Scripts\python_runner\check_ext005_semantische_suche.py"

Write-Host "========================================"
Write-Host " EXT-005 - Semantische Suche Autolauf"
Write-Host "========================================"
...
Write-Host ""
Write-Host "EXT-005 Autolauf erfolgreich abgeschlossen."
