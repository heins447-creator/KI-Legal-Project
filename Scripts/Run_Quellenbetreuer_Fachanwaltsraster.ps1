...
$Runner = Join-Path $Root "Scripts\python_runner\046_quellenbetreuer_fachanwaltsraster_v1.py"
$Checker = Join-Path $Root "Scripts\python_runner\047_check_quellenbetreuer_fachanwaltsraster_v1.py"
$LogDir = Join-Path $Root "Windows_App\Logs"
$Ts = Get-Date -Format "yyyy-MM-dd_HH-mm-ss"
$Report = Join-Path $LogDir "RUN_Quellenbetreuer_Fachanwaltsraster_$Ts.txt"
$Failed = $false
...
try {
    W "QUELLENBETREUER FACHANWALTSRASTER gestartet."
    W "Root: $Root"
    W "Python: $Python"
    W "Report: $Report"
    ...
    W "OK: Quellenbetreuer Fachanwaltsraster abgeschlossen."
