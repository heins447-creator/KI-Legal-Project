# UI04b LOGIKPRUEFUNG UND ENTSCHEIDUNG AUTOLAUF
$ErrorActionPreference = "Stop"
$ROOT = "I:\KI_Legal_Project"
$PYTHON = "$ROOT\Tools\Python312\python.exe"
$RUNNER = "$ROOT\Scripts\python_runner\ui04b_logikpruefung_entscheidung.py"
$CHECK = "$ROOT\Scripts\python_runner\check_ui04b_logikpruefung_entscheidung.py"
$LOG = "$ROOT\Windows_App\Logs\UI04b_AUTOLAUF_BERICHT.txt"
...
Write-Log "UI04b AUTOLAUF START"
Write-Log "======================================"
...
if ($ok1 -and $ok2 -and $ok3 -and $ok4 -and $ok5) {
    ...
    git -C $ROOT add -A
    git -C $ROOT commit -m "UI04b Logikpruefung und gefuehrte Entscheidungsmaske erstellt"
    Write-Log "Git-Commit erfolgt"
} else {
    Write-Log "AUTOLAUF NICHT VOLLSTAENDIG BESTANDEN"
}

Write-Log "UI04b AUTOLAUF ENDE"
