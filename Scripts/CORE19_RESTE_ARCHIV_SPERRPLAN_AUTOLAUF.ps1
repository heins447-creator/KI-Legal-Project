...
.DESCRIPTION
    Erstellt Plaene fuer nicht-kopierte Dateien.
...
$runner = Join-Path $projektWurzel "Scripts\python_runner\core19_reste_archiv_sperrplan.py"
$check = Join-Path $projektWurzel "Scripts\python_runner\check_core19_reste_archiv_sperrplan.py"

function Write-Log {
    param([string]$msg)
    Write-Host "[CORE-19] $msg"
}

Write-Log "Starte CORE-19 Reste-/Archiv-/Sperrplan..."
...
Write-Log "CORE-19 RESTE-/ARCHIV-/SPERRPLAN ERFOLGREICH ABGESCHLOSSEN."
