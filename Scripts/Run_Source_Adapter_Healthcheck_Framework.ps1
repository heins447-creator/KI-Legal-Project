...
$Runner = Join-Path $Root "Scripts\python_runner\053_source_adapter_healthcheck_framework_v1.py"
$Checker = Join-Path $Root "Scripts\python_runner\054_check_source_adapter_healthcheck_framework_v1.py"
$LogDir = Join-Path $Root "Windows_App\Logs"
$Ts = Get-Date -Format "yyyy-MM-dd_HH-mm-ss"
$Report = Join-Path $LogDir "RUN_Source_Adapter_Healthcheck_Framework_$Ts.txt"
$Failed = $false
...
try {
    W "SOURCE ADAPTER HEALTHCHECK FRAMEWORK V1 gestartet."
    W "Root: $Root"
    W "Python: $Python"
    W "Report: $Report"
    ...
    W "OK: Source Adapter Healthcheck Framework V1 abgeschlossen."
