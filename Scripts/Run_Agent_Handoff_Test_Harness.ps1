...
$Runner = Join-Path $Root "Scripts\python_runner\055_agent_handoff_test_harness_v1.py"
$Checker = Join-Path $Root "Scripts\python_runner\056_check_agent_handoff_test_harness_v1.py"
$LogDir = Join-Path $Root "Windows_App\Logs"
$Ts = Get-Date -Format "yyyy-MM-dd_HH-mm-ss"
$Report = Join-Path $LogDir "RUN_Agent_Handoff_Test_Harness_$Ts.txt"
$Failed = $false
...
try {
    W "AGENT HANDOFF TEST HARNESS gestartet."
    W "Root: $Root"
    W "Python: $Python"
    W "Report: $Report"
    ...
    W "OK: Agent Handoff Test Harness abgeschlossen."
