...
$Runner       = "$BaseDir\Scripts\python_runner\ext004_fastapi_backend.py"
$Check        = "$BaseDir\Scripts\python_runner\check_ext004_fastapi_backend.py"

Write-Host "========================================"
Write-Host " EXT-004 - FastAPI-Backend Autolauf"
Write-Host "========================================"
...
Write-Host ""
Write-Host "EXT-004 Autolauf erfolgreich abgeschlossen."
