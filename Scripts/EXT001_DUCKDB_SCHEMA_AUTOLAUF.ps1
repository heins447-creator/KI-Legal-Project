...
$Runner = "Scripts\python_runner\ext001_duckdb_schema.py"
$Check  = "Scripts\python_runner\check_ext001_duckdb_schema.py"
...
Write-Host "EXT-001 Autolauf erfolgreich abgeschlossen."
