...
Write-Host "Phase 0, AP 0.5 Redline-Guard starten" -ForegroundColor Cyan
...
$Runner = Join-Path $BaseDir "Scripts\python_runner\phase0_ap05_redline_guard.py"
$Check = Join-Path $BaseDir "Scripts\python_runner\check_phase0_ap05_redline_guard.py"
...
Write-Host "Phase 0, AP 0.5 erfolgreich abgeschlossen" -ForegroundColor Green
