...
Write-Host "Phase 0, AP 0.6 Dispatcher starten" -ForegroundColor Cyan
...
$Runner = Join-Path $BaseDir "Scripts\python_runner\phase0_ap06_dispatcher_setup.py"
$Check = Join-Path $BaseDir "Scripts\python_runner\check_phase0_ap06_dispatcher.py"
...
Write-Host "Phase 0, AP 0.6 erfolgreich abgeschlossen" -ForegroundColor Green
