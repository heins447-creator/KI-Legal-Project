# Phase 0, AP 0.1: Dependency-Setup
...
Write-Host "Phase 0, AP 0.1 Dependency-Setup starten" -ForegroundColor Cyan
...
$Runner = Join-Path $BaseDir "Scripts\python_runner\phase0_ap01_dependency_setup.py"
$Check = Join-Path $BaseDir "Scripts\python_runner\check_phase0_ap01_dependency_setup.py"
...
Write-Host "Phase 0, AP 0.1 erfolgreich abgeschlossen" -ForegroundColor Green
