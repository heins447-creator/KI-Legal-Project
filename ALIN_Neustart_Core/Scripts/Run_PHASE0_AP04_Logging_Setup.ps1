...
Write-Host "Phase 0, AP 0.4 JSON-Logging starten" -ForegroundColor Cyan
...
$Runner = Join-Path $BaseDir "Scripts\python_runner\phase0_ap04_logging_setup.py"
$Check = Join-Path $BaseDir "Scripts\python_runner\check_phase0_ap04_logging_setup.py"
...
Write-Host "Phase 0, AP 0.4 erfolgreich abgeschlossen" -ForegroundColor Green
