...
Write-Host "Phase 0, AP 0.3 pytest-Setup starten" -ForegroundColor Cyan
...
$Runner = Join-Path $BaseDir "Scripts\python_runner\phase0_ap03_pytest_setup.py"
$Check = Join-Path $BaseDir "Scripts\python_runner\check_phase0_ap03_pytest_setup.py"
...
Write-Host "Phase 0, AP 0.3 erfolgreich abgeschlossen" -ForegroundColor Green
